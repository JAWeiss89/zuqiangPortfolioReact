  ...
  return (
    <section onClick={hideNav} id="content" className="landing">
      ...
      <p><b>Exhibition Projects :</b></p>
            ...
            <p style={{margin:'0px', fontSize:'14px'}}><a href="https://thecommonguild.org.uk/programme/peng-zuqiang-afternoon-hearsay" target="_blank" rel="noopener noreferrer"><em> Afternoon Hearsay </em></a></p>
            <p style={{margin:'0px', fontSize:'12px'}}>The Common Guild, Glasgow, Oct 11 – Dec 7,2025 </p>

            <p style={{margin:'0px', fontSize:'14px'}}><a href="https://www.rockbundartmuseum.org/exhibition/peng-zuqiang-short-term-histories" target="_blank" rel="noopener noreferrer"><em> Short-term Histories </em></a></p>
      ...
      <p style={{ margin: 0, fontSize: '14px', whiteSpace: 'nowrap' }}>
        ...
        <span style={{ fontSize: '12px' }}>
          ...
          <p><b>Recents:</b></p>
            ...
            <p style={{margin:'0px', fontSize:'14px'}}><a href="https://www.taikwun.hk/en/programme/detail/stay-connected-navigating-the-cloud/1637" target="_blank" rel="noopener noreferrer"><em> Safe House </em></a></p>
            <p style={{margin:'0px', fontSize:'12px'}}>Tai Kwun Contemporary, Hong Kong. Oct 3-4, 2025 </p>

            <p style={{margin:'0px', fontSize:'14px'}}><a href="https://www.siskelfilmcenter.org/frederic-moffet" target="_blank" rel="noopener noreferrer"><em> You're too lovely to last </em></a></p>
            <p style={{margin:'0px', fontSize:'12px'}}>Gene Siskel Film Center, Chicago. September 11, 2025 </p>

            <p style={{margin:'0px', fontSize:'14px'}}><a href="https://wattis.org/calendar/wednesday-september-24-2025" target="_blank" rel="noopener noreferrer"><em> Film screening: Mary Helena Clark, Peng Zuqiang, and Ana Vaz </em></a></p>
