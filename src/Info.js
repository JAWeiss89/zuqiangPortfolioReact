...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p> Exhibitions and screenings include Fondazione Sandretto (2023), videobrasil (2023), Kevin Space (2023), Cell Project Space (2022), E-Flux screening room (2022), Alchemy Film and Moving Image Festival (2024,2023), 25FPS (2022). He is a recipient of the Illy Present Future prize in 2022, and the Dialog Award at EMAF 2023. A resident artist at Rijksakademie van beeldende kunsten (2022-24), he lives and works in Amsterdam.</p>
        </section>
    )
}
