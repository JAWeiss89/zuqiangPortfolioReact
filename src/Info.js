...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p>-</p>
            <p>Peng Zuqiang works with film, video, printmaking and installations. He is interested in the histories of media and mediums—ranging from obsolete film formats to clandestine radio—with an attention to their affective resonances and dissenting futures.
</p>
