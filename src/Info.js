...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p> Recent solo presentations include Fondazione Sandretto (2023), Kevin Space (2023), Cell Project Space (2022), E-Flux screening room (2022).</a></p>
            <p> Group exhibitions and screenings include videobrasil (2023), Alchemy Film and Moving Image Festival (2024,2023), 25FPS (2022).</a></p>
            <p> He is a recipient of the Present Future prize at Artissima (2022), and the Dialog Award at EMAF (2023, 2024).</a></p>
            <p> A resident artist at Rijksakademie van beeldende kunsten (2022-24). He lives and works in Amsterdam.</p>
        </section>
    )
}
