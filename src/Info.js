...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p> Group exhibitions and screenings include videobrasil (2023), Alchemy Film and Moving Image Festival (2024,2023), 25FPS (2022).
            <p> He is a recipient of the Present Future prize at Artissima (2022), and the Dialog Award at EMAF (2023, 2024).
