...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p> Recent solo presentations include Concordia (2026), Rockbund Art Museum (2025), The Common Guild (2025), Fondazione Sandretto (2023), Kevin Space (2023), Cell Project Space (2022), E-Flux screening room (2022). </p>
            <p> Group exhibitions and screenings include IFFR, videobrasil, UCCA Beijing, Schirn Kunsthalle Frankfurt, Times Museum, Eye Film Museum, IDFA, 25FPS, Alchemy Film and Moving Image Festival. </p>
