...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p>-</p>
            <p>Peng Zuqiang works with film, video, printmaking and installations. His practice explores the histories of media and mediums—ranging from obsolete film formats to clandestine radio—with an attention to the affective resonances of their presences and futures.
</p>
