...
const Info = ({hideNav}) => {
    return  (   
        <section onClick={hideNav} id="content">
            ...
            <p>for exhibitions/gallery: <div style={{ display: 'flex'}}><a href="mailto:info@antenna-space.com"><p style={{ margin: '0' }}>info@antenna-space.com</p></a></div>
            <p>for screenings/distribution: <div style={{ display: 'flex'}}><a href="mailto:info@vdb.org"><p style={{ margin: '0' }}>info@vdb.org</p></a></div>
            <p>-</p>
